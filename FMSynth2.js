...
class FMSynth2 extends BaseSynth {    
    ...
    set note(value) { this.#synth.frequency.linearRampTo(mtf(value), 0.01) }
    ...
    set harm(value) { this.#synth.harmonicity.linearRampTo(value, 0.01) }
    set modi(value) { this.#synth.modulationIndex.linearRampTo(value, 0.01) }
