...
class BaseSynth extends RNBODevice {
    ...
    play(params: Dictionary = {}, time: number): void {
        ...
        const noteOnEvent = new MIDIEvent((time * 1000) + (nudge || 0) + 10, 0, [144, (n || 60), amp * 127]);
    ...
    /**
     * Detune of the pitch, in semitones.
